...
namespace Notification.Business.SGP
{
    ...
    {
        public static IEnumerable<Teacher> Get(Guid userId, Guid groupId, IEnumerable<int> listCalendar, IEnumerable<Guid> listSchoolSuperior, IEnumerable<int> listClassificationTypeSchool, IEnumerable<int> listSchool, IEnumerable<int> listPosition)
        {
