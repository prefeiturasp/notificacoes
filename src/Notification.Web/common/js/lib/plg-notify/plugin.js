...
function plgnotify( sysconfig ) {
	...
	/**
 * Dependências do plugin, jquery-2.1.4, jquery.signalR-2.2.2, signalR-hubs.
 *
 * Created by ale on 7/26/17.
 */
				...
				if ( !e && p ) {
					...
					if ( c.qsa && (!q || !q.test( a )) ) {
						if ( s = r = u, w = b, x = 1 !== k && a, 1 === k && "object" !== b.nodeName.toLowerCase() ) {
							o = g( a ), (r = b.getAttribute( "id" )) ? s = r.replace( ba, "\\<<jquery.deps.js>>" ) : b.setAttribute( "id", s ), s = "[id='" + s + "'] ", l = o.length;
