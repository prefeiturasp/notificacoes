...
function plgnotify( sysconfig ) {
	...
	function hasPlugin() {
		...
		html = '<div draggable="true" class="float-menu plg-notify">' +
			   ...
			   '</div>' +
			   '<a class="numeracao hitbox"><span class="plg-notify-counter"></span></a>' +
			   '</div>' +
	...
	function addSocketListeners() {
		...
		socket.connection.connection.socket.onmessage = onSocketMessage;
	}
