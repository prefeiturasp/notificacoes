...
var plgnotify = function ( sysconfig ) {
	...
	function showMessage( dom ) {
		...
		modal = '<div class="plgmodal" id="plgmodal" aria-hidden="true">' +
				...
				'<a href="#" class="plgmodal-btn-close plgmodal-btn-big" aria-hidden="true">×</a>' +
				'</div>' +
				'<div class="plgmodal-body">' +
				'<p><span class="plgloader"></span></p>' +
				'</div>' +
				'<div class="plgmodal-footer">' +
				'<div class="plgmodal-left plg-icon-btn" title="Ler mais tarde">' +
				...
				'<a href="#" class="plgmodal-btn-close plgmodal-btn ">Fechar</a>' +
				'</div>' +
				'</div>' +
				'</div>' +
				'</div>';
	...
	function startSocket() {
		...
		if ( !socket || socket && socket.hasHubs ) {
			...
			if ( !socket.hasHubs ) {
				...
				hubs.src    = socket.url +( socket.url.match( '/' ) ? 'hubs' : '/' + 'hubs');
